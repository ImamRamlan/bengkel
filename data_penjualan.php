...
$title = "Data Penjualan | Bengkel Rinus";
...
try {
    ...
    $stmt = $koneksi->prepare("SELECT id_suku_cadang, nama_suku_cadang, stok, harga_per_unit, gambar FROM suku_cadang ORDER BY nama_suku_cadang ASC");
    $stmt->execute();
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        Stok: <?php echo htmlspecialchars($suku_cadang['stok']) ? htmlspecialchars($suku_cadang['stok']) : '0'; ?><br>
                                        Harga: Rp <?php echo number_format($suku_cadang['harga_per_unit'], 2, ',', '.'); ?>
                                    </p>
                                    <a href="detail_penjualan.php?id_suku_cadang=<?php echo $suku_cadang['id_suku_cadang']; ?>" class="btn btn-secondary mt-2 btn-block">Detail</a>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
